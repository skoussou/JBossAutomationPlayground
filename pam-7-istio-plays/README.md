...
![Routing to custom-kieserver-kjar-a services of different version based on HEADER - 50/50](./images/KJAR-A-V-1-1-0-2-Versions-BusinessService-50-50-WITH-WITHOUT-HEADER.png "Routing to custom-kieserver-kjar-a services of different version based on HEADER - 50/50")
* And the same by stopping requests without the header reduces the % going to the custom-kieserver-kjar-a-v150 KIE Server
![Routing to custom-kieserver-kjar-a services of different version based on HEADER- unequal](./images/KJAR-A-V-1-1-0-2-Versions-BusinessService-UNEQUAL-requests-WITH-WITHOUT-HEADER.png "Routing to custom-kieserver-kjar-a services of different version based on HEADER - unequal")
