...
@ApplicationScoped
public class MaestroAsyncTaskLifeCycleEventProducer extends PersistableEventListener implements TaskLifeCycleEventListener {

	private static final Logger logger = LoggerFactory.getLogger(MaestroAsyncTaskLifeCycleEventProducer.class);

	@Resource(lookup="java:/JmsXA")
	private ConnectionFactory connectionFactory;    
	
	@Resource(name="queue/KIE.AUDIT.ALL", lookup="java:jboss/exported/jms/queue/KIE.AUDIT")
	private Queue queue;
	private boolean transacted = true;
	private XStream xstream;

	public MaestroAsyncTaskLifeCycleEventProducer() {
		super(null);
		initXStream();
	}
	...
	public void afterTaskStartedEvent(TaskEvent event) {
		...
		logger.info("# ADMINISTRATORS LIST ["+event.getTask().getPeopleAssignments().getBusinessAdministrators()+"] #");
		logger.info("# POTENTIAL OWNERS LIST ["+event.getTask().getPeopleAssignments().getPotentialOwners()+"] #");
		logger.info("# EXCLUDED OWNERS LIST ["+((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners()+"] #");
		...
		MaestroAuditTaskData customAuditTask = new MaestroAuditTaskData(auditTaskImpl, taskEvent);
		customAuditTask.setBusinessOwners(event.getTask().getPeopleAssignments().getBusinessAdministrators());
		customAuditTask.setPotentialOwners(event.getTask().getPeopleAssignments().getPotentialOwners());
		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
		
		//		sendMessage(new AuditTaskData(auditTaskImpl, taskEvent), 5);

		sendMessage(customAuditTask, 5);
	}
...
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
	...
	public void afterTaskStoppedEvent(TaskEvent event) {
		...
		// Custom new DTO for Maestro Additional required content
		MaestroAuditTaskData customAuditTask = new MaestroAuditTaskData(auditTaskImpl, taskEvent);
		customAuditTask.setBusinessOwners(event.getTask().getPeopleAssignments().getBusinessAdministrators());
		customAuditTask.setPotentialOwners(event.getTask().getPeopleAssignments().getPotentialOwners());
		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
		
		//sendMessage(new AuditTaskData(auditTask, taskEvent), 4);
		sendMessage(customAuditTask, 9);
	}
...
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
	...
	public void afterTaskAddedEvent(TaskEvent event) {
		...
		// Custom new DTO for Maestro Additional required content
		MaestroAuditTaskData customAuditTask = new MaestroAuditTaskData(auditTask, taskEvent);
		customAuditTask.setBusinessOwners(event.getTask().getPeopleAssignments().getBusinessAdministrators());
		customAuditTask.setPotentialOwners(event.getTask().getPeopleAssignments().getPotentialOwners());
		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
...
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
	...
	public void afterTaskReleasedEvent(TaskEvent event) {        
		...
		MaestroAuditTaskData customAuditTask = new MaestroAuditTaskData(auditTaskImpl);
//		customAuditTask.setBusinessOwners(event.getTask().getPeopleAssignments().getBusinessAdministrators());
//		customAuditTask.setPotentialOwners(event.getTask().getPeopleAssignments().getPotentialOwners());
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
...
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
	...
	public void beforeTaskReleasedEvent(TaskEvent event) {
		...
		MaestroAuditTaskData customAuditTask = new MaestroAuditTaskData(null, taskEvent);
//		customAuditTask.setBusinessOwners(event.getTask().getPeopleAssignments().getBusinessAdministrators());
//		customAuditTask.setPotentialOwners(event.getTask().getPeopleAssignments().getPotentialOwners());
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
	...
	public void afterTaskUpdatedEvent(TaskEvent event) {
		...
		try {
			...
			MaestroAuditTaskData customAuditTask = new MaestroAuditTaskData(auditTaskImpl, taskEvents);
//			customAuditTask.setBusinessOwners(event.getTask().getPeopleAssignments().getBusinessAdministrators());
//			customAuditTask.setPotentialOwners(event.getTask().getPeopleAssignments().getPotentialOwners());
//			customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
...
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
	...
	public void afterTaskOutputVariableChangedEvent(TaskEvent event, Map<String, Object> variables) {
		...
		MaestroAuditTaskData customAuditTask = new MaestroAuditTaskData(auditTaskImpl, Collections.singletonList(taskEvent), null, taskVariables);
//		customAuditTask.setBusinessOwners(event.getTask().getPeopleAssignments().getBusinessAdministrators());
//		customAuditTask.setPotentialOwners(event.getTask().getPeopleAssignments().getPotentialOwners());
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
	...
	public void afterTaskInputVariableChangedEvent(TaskEvent event, Map<String, Object> variables) {
		...
		MaestroAuditTaskData customAuditTask = new MaestroAuditTaskData(null, null, taskVariables, null);
//		customAuditTask.setBusinessOwners(event.getTask().getPeopleAssignments().getBusinessAdministrators());
//		customAuditTask.setPotentialOwners(event.getTask().getPeopleAssignments().getPotentialOwners());
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
...
//		customAuditTask.setExcludedOwners(((InternalPeopleAssignments) event.getTask().getPeopleAssignments()).getExcludedOwners());
	...
	protected void sendMessage(MaestroAuditTaskData auditTaskData, int priority) {
		if (connectionFactory == null && queue == null) {
			throw new IllegalStateException("ConnectionFactory and Queue cannot be null");
		}
		
		logger.info("##################################################");
		logger.info("SENDING [MaestroAuditTaskData] FROM my AUDIT LOGGER");
		logger.info("##################################################");
...
//		
//		logger.info("##################################################");
//		logger.info("SENDING FROM my AUDIT LOGGER");
//		logger.info("##################################################");
//		
//		
//		Connection queueConnection = null;
...
//	}
	...
	public boolean equals(Object obj) {
		...
		if ( obj == null ) 
			return false;
		if ( (obj instanceof MaestroAsyncTaskLifeCycleEventProducer) ) 
			return true;
